export const I18N_EN = {
  ...
  CONFIG: {
    ...
    LOGIN_SETUP_FUNCTIONS_DETECTED: 'Detected functions',
    LOGIN_SETUP_BLOCK_ASSIGN: 'Block assignment',
  ...
  RECORDER: {
    ...
    FILE_UPLOAD_MANUAL_TOAST: 'Add {files} to cypress/fixtures/ before running the test.',
    FILE_UPLOAD_COPIED_TOAST: '{files} copied to cypress/fixtures/.',
    FILE_UPLOAD_COPY_ERROR_TOAST: 'Could not copy {files} to cypress/fixtures/. Add it manually.',
    BTN_CONFIG: 'Config',
    BTN_FILES: 'Files',
