export const I18N_ES = {
  ...
  CONFIG: {
    ...
    LOGIN_SETUP_FUNCTIONS_DETECTED: 'Funciones detectadas',
    LOGIN_SETUP_BLOCK_ASSIGN: 'Asignación de bloques',
    ...
    LOGIN_SETUP_SOURCE_LABEL: 'Origen del fichero de login',
    LOGIN_SETUP_CREATE_SUB: 'Genera un scaffold con funciones de ejemplo',
    LOGIN_SETUP_SELECT_SUB: 'Apunta a un servicio de login existente',
    LOGIN_SETUP_INJECT_TITLE: '¿Añadir bloques de login?',
    LOGIN_SETUP_INJECT_TEXT: 'Este fichero no tiene los bloques de login configurados. ¿Quieres añadir el import y los bloques before/beforeEach ahora?',
    LOGIN_SETUP_INJECT_CONFIRM: 'Sí, añadir',
  },
  SELECTOR_PICKER: {
  ...
  RECORDER: {
    ...
    FILE_UPLOAD_MANUAL_TOAST: 'Añade {files} a cypress/fixtures/ antes de ejecutar el test.',
    FILE_UPLOAD_COPIED_TOAST: '{files} copiado/s a cypress/fixtures/.',
    FILE_UPLOAD_COPY_ERROR_TOAST: 'No se pudo copiar {files} a cypress/fixtures/. Añádelo manualmente.',
    BTN_CONFIG: 'Config',
    BTN_FILES: 'Ficheros',
  ...
  HELP: {
    ...
    PANEL_CONFIG: '⚙️ Config — idioma, selector, HTTP, carpeta Cypress, login setup, datos, visibilidad, posición.',
    ...
    ADV_LOGIN: 'Login Setup (Ctrl+3): apunta a tu servicio de login; el grabador inyecta before()/beforeEach() automáticamente en cada test nuevo.',
    CLOSE: 'Cerrar',
    ...
    G_COV_7: 'Login Setup: configura tu función de login en Ctrl+3 → Login Setup y el grabador añade los bloques before()/beforeEach() a cada test nuevo.',
